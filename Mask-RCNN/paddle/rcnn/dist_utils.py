...
def nccl2_prepare(trainer_id, startup_prog, main_prog):
    ...
    envs = dict()
    envs['trainer_endpoints'] = os.environ.get('PADDLE_TRAINER_ENDPOINTS')
    envs['current_endpoint'] = os.environ.get('PADDLE_CURRENT_ENDPOINT')
    print("trainer_endpoints", envs['trainer_endpoints'])
    print("current_endpoint", envs['current_endpoint'])
    t.transpile(trainer_id,
        trainers=envs["trainer_endpoints"],
