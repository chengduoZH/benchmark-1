...
def train():
    ...
    if cfg.parallel:
        ...
        if num_trainers > 1:
            nccl2_prepare(trainer_id, fluid.default_startup_program(), main_prog=fluid.default_main_program())
        exe.run(fluid.default_startup_program())
 
        exec_strategy = fluid.ExecutionStrategy()
        exec_strategy.use_experimental_executor = True
        train_exe = fluid.ParallelExecutor(num_trainers=num_trainers,trainer_id=trainer_id,
